...
public abstract class ValleyBikeController {
     ...
     */
    static void returnToLastMenu(String username) throws IOException, ParseException, InterruptedException {
     ...
     * @param username is the unique username associated with the customer account
     */
    private static void editCustomerAccount(String username) throws ParseException, InterruptedException, IOException {
...
//        }
     ...
     */
    private static String enterUsername() throws ParseException, InterruptedException, IOException {
        //prompts user to input username
     ...
     */
    private static String enterPassword() throws ParseException, InterruptedException, IOException {
        //prompts user to input password
     ...
     */
    private static String enterEmail() throws ParseException, InterruptedException, IOException {
     ...
     */
    private static String enterCreditCard() throws ParseException, InterruptedException, IOException {
        //prompts user to input email address
     ...
     */
    private static int enterMembership() throws ParseException, InterruptedException, IOException {
